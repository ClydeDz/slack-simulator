...
const BG_COLORS = [
  ...
  '00acc1','e91e63','9c27b0','673ab7','3f51b5',
...
const SHAPE_COLORS = [
  'ff595e','ff924c','ffca3a','8ac926','52b788',
  '1982c4','6a4c93','f72585','ff006e','fb5607',
  '3a86ff','06d6a0','ef476f','ffd166','56cfe1',
  'ff70a6','80b918','ffb703','4cc9f0','c77dff',
]

export function getAvatarSvg(seed: string, size = 36): string {
