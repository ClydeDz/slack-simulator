...
export default function ChannelList({ onCreateChannel }: Props) {
  ...
  const publicAndPrivate = channels.filter(
        ...
        >
          {channel.type === 'private' ? (
            <svg
              ...
              style={{ flexShrink: 0, opacity: 0.7, display: 'block' }}
            >
