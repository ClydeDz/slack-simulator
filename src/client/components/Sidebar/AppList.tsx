...
export default function AppList() {
  const { apps, channels, actingUserId, activeChannelId, unreadCounts, setActiveChannel } = useStore()
  ...
  return (
    <div style={{ marginTop: 'var(--slacksim-space-4)' }}>
      <div style={{
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ flexShrink: 0, opacity: 0.75 }}>
