...
export default function MainPane() {
  ...
  const humanCount = channel.members.filter(id => users.some(u => u.id === id)).length
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--slacksim-space-2)' }}>
          {!isIm && (
            channel.type === 'private'
              ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, color: 'var(--slacksim-color-fg-muted)', marginRight: -2 }}><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
              : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, color: 'var(--slacksim-color-fg-muted)', marginRight: -2 }}><line x1="4" x2="20" y1="9" y2="9"/><line x1="4" x2="20" y1="15" y2="15"/><line x1="10" x2="8" y1="3" y2="21"/><line x1="16" x2="14" y1="3" y2="21"/></svg>
          )}
          <span style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--slacksim-space-2)' }}>
          {!isIm && !channel.archived && (
            <button
              ...
              style={{
                background: isMember ? 'var(--slacksim-color-sidebar-badge-bg)' : 'var(--slacksim-color-primary)',
          ...
          {!isIm && (
            <button
              ...
              className={channel.archived ? 'ss-header-btn-filled' : 'ss-header-btn-outline'}
              style={{
                background: channel.archived ? 'var(--slacksim-color-primary)' : 'transparent',
                color: channel.archived ? 'var(--slacksim-color-sidebar-fg-active)' : 'var(--slacksim-color-fg-muted)',
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderBottom: '2px solid var(--slacksim-color-sidebar-bg)',
            cursor: 'pointer',
            fontSize: 'var(--slacksim-font-size-sm)',
            fontWeight: 'var(--slacksim-font-weight-bold)',
            color: 'var(--slacksim-color-fg)',
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="var(--slacksim-color-sidebar-bg)" stroke="var(--slacksim-color-sidebar-bg)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
